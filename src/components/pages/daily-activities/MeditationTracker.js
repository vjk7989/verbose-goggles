...
>
    {({ remainingTime }) => (
        running === false
            ? <IconButton onClick={start} title="Start Meditation"><PlayArrowOutlinedIcon className="play-icon" /></IconButton>
            : <IconButton onClick={stop} title="Pause Meditation"><PauseOutlinedIcon className="pause-icon" /></IconButton>
    )}
</CountdownCircleTimer>
